...
//-----------------------------------
#define INDEX_NUMBER 10000
#define DEPENDENT_PERCENT 20
#define VOLATILITY  100
extern unordered_map<int, std::vector<int> > index_;
extern vector<pthread_mutex_t> mutex_for_index;
//-----------------------------------
...
class Client {
 public:
  virtual ~Client() {}
  virtual void GetTxn(TxnProto** txn, int txn_id, int dependent) = 0;
};
