...
class Microbenchmark : public Application {
 public:
  enum TxnType {
    ...
    MICROTXN_SP = 1,
    MICROTXN_MP = 2,
    MICROTXN_DEPENDENT_SP = 3,
    MICROTXN_DEPENDENT_MP = 4,
  };
  ...
  TxnProto* MicroTxnDependentSP(int64 txn_id, int64 index_number);
  TxnProto* MicroTxnDependentMP(int64 txn_id, int part1, int part2, int64 index_number);
